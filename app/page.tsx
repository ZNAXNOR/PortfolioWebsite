    ...
    <section className="container mx-auto relative flex flex-col lg:flex-row">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div className="flex flex-col px-8 lg:px-16">
          ...
          <a href="/resume">
            <button className="mt-10 w-full rounded-md bg-transparent px-3.5 py-2.5 
        ...
        <div className="flex flex-col">
          ...
          <div className="lg:mt-5 text-center mt-5 mx-auto lg:text-left">
            ...
            <div className="prose prose-neutral dark:prose-invert text-balance">
              <p>
                Hello! This is Omkar and welcome to my portfolio website!
              </p>
              <p>
                This website was designed with NextJS as framework for clean, fast, and lightweight tools
                to showcase projects and skills effectively. I plan to add some new features in the future.
                If you have any suggestions, feel free to leave them {" "} 
                <a href="/suggestions" target="_blank">here.</a>
              </p>
              <p>
                The site is open-source and customizable, making it a perfect starting point for 
                unique portfolios. Explore my projects, skills, and more as you scroll. You can 
                also access the website code and contribute {" "} 
                <a href="https://github.com/ZNAXNOR/PortfolioWebsite/tree/NextJSapp" target="_blank">here.</a>
              </p>
              <p>
                If you encounter any issue, feel free to let me know {" "} 
                <a href="/feedback" target="_blank">here.</a>
              </p>
            </div>
          </div>
        </div>
