...
import {BriefcaseIcon, MapPinIcon, ClockIcon, DocumentDuplicateIcon, 
        ...
        ArrowDownTrayIcon} from '@heroicons/react/20/solid'
        ...
        <div className="mt-5 flex lg:ml-4 lg:mt-0">
          ...
          <Menu as="div" className="relative mr-3">
            ...
            <MenuItems transition className="absolute right-0 z-10 -mr-1 mt-2 w-48 origin-top-right
              ...
              <MenuItem>
                <a href="certifications" className="flex px-4 py-2 text-sm text-gray-700
                            data-[focus]:bg-gray-100 data-[focus]:outline-none">
                  <DocumentDuplicateIcon aria-hidden="true" className="mr-1.5 size-5 text-gray-400" />
                  Certifications
                </a>
              </MenuItem>
              <MenuItem>
                <a href="projects" className="flex px-4 py-2 text-sm text-gray-700
                            data-[focus]:bg-gray-100 data-[focus]:outline-none">
                  <ComputerDesktopIcon aria-hidden="true" className="mr-1.5 size-5 text-gray-400" />
                  Projects
                </a>
              </MenuItem>
            </MenuItems>
            ...
            <ul role="list" className="divide-y divide-gray-100 rounded-sm border border-gray-200 bg-white dark:bg-gray-800">
              <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm/6">
                ...
                <div className="ml-4 shrink-0">
                  <a href={socialLinks.resume} target="_blank" >                      
                    <button className="flex justify-between font-medium rounded-full ring ring-orange-600 py-1 px-4
                            hover:bg-orange-100 dark:hover:bg-orange-200/100 text-orange-600 ms-3">
                    <ArrowDownTrayIcon aria-hidden="true" className="mx-auto md:mr-1.5 size-5 shrink-0 font-bold text-orange-600" />
                    <p className="hidden sm:block underline">Download</p></button>                    
                  </a>
                </div>
              </li>              
            </ul>
